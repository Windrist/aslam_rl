...
class robot:
    ...
    def __init__(self, name):
        ...
        self.goalPub = rospy.Publisher('/frontier_goal', MoveBaseGoal, queue_size = 10)
        self.shutdownPub = rospy.Publisher('/terminate', Bool, queue_size = 10)
    ...
    def terminate(self):
        termi = Bool()
        termi.data = True
        self.shutdownPub.publish(termi)
# ________________________________________________________________________________
